var governmentalentity_tbl = $("#governmentalentity_tbl");
var governmentalentity_msf = null;

window.app.defineEvents();

/* GovernmentalEntity DataTable Define */
window.app.definePageDatatable({
    tableElementId: "#governmentalentity_tbl",
    options: {
        columns: [
            {
                data: "DT_RowIndex",
